...
## 安装图形库和显示驱动组件:
 ...
 [espressif/esp_lvgl_port • v2.6.1 • ESP Component Registry](https://components.espressif.com/components/espressif/esp_lvgl_port/versions/2.6.1/readme) 

```c
idf.py add-dependency "espressif/esp_lvgl_port^2.6.1"
```

## 安装中文字体库组件:

 [78/xiaozhi-fonts • v1.5.3 • ESP Component Registry](https://components.espressif.com/components/78/xiaozhi-fonts/versions/1.5.3/readme) 

```c
idf.py add-dependency "78/xiaozhi-fonts^1.5.3"
```
